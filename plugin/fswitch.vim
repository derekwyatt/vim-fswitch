...
augroup fswitch_au_group
    ...
    au BufEnter *.cpp  call s:SetVariables('hpp,h,hh',   'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    ...
    au BufEnter *.hh   call s:SetVariables('cc,cpp,cxx', 'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
